...
## CURRENT T23 FINDINGS AUTHORITY — P2-T23-R3B (2026-09-13)

R3B implementa playback cliente confirmado y harness de replay Testing. La
certificación física sigue pendiente y no se declara cerrado T23.
...
## CURRENT T23 FINDINGS AUTHORITY — P2-T23-R3A (2026-09-13)

R3A cierra la capa de productor y transporte bounded en Testing. El fallo físico
de R1 sigue abierto para playback hasta R3B; no se certifica todavía smoothness.
...
## CURRENT T23 FINDINGS AUTHORITY — P2-T23-R2A (2026-09-13)

La evidencia R1 de `STEPWISE_JUMPS` se conserva. La nueva decisión de producto
no busca sólo interpolar una recta: exige preservar muestras reales en un
buffer bounded y transportarlas como trayectoria efímera. R2 fue abortado antes
de commit y no es una solución vigente.
...
## CURRENT FINDINGS AUTHORITY — POST-P2-T02-R6 (2026-09-13)
...
## CURRENT T02 FINDINGS AUTHORITY — P2-T02-R6 (2026-09-13)

La evidencia física final cierra T02 global en Testing. El movimiento del
marcador quedó caracterizado como saltos punto a punto, sin interpolación: no
se clasifica como regresión de T02 ni se sobredeclara una animación en curvas.
Es evidencia confirmada para T23 y alcance parcial relacionado con T24.
...
No se abre un finding de regresión B3: la suspensión posterior al entrar en
background es la limitación explícita del contrato PWA best-effort y la UI
de stale fue honesta (`En vivo` → `Pausado`). No se abre un finding de
finalización: el pedido salió de activos, pasó a historial y no retomó
tracking pese al movimiento posterior.

Reporte: `codex-reports/P2_T02_R6_FINAL_PHYSICAL_EVIDENCE_RECONCILIATION.md`.

## CURRENT T23 FINDINGS AUTHORITY — P2-T23-A0 (2026-09-13)

La evidencia R6 confirma el comportamiento visual `STEPWISE_JUMPS`. La causa
es combinada: el productor entrega anclajes discretos por filtro/throttle y el
Cliente aplica cada punto con `setLatLng` sin playback. No se abre un finding de
tracking ni se cambia T02; queda diseñado el alcance futuro de T23.
...
STATUS=RESOLVED_BY_P2_T38_CLOSED_TESTING_CERTIFIED
...
FORMALIZED_AS_TASK=P2-T38 (PWA Installation UX — Android completion-state + iOS guided tutorial; ver P2_T32_PHYSICAL_CERTIFICATION_CLOSEOUT_AND_BACKLOG_ADDITIONS.md §4).
RESOLVED_BY=P2-T38-R1_PHYSICAL_RECERTIFICATION_CLOSEOUT
