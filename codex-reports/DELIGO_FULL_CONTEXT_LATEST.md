...
## CURRENT T23 AUTHORITY — P2-T23-R3B (2026-09-13)
...
## CURRENT T23 AUTHORITY — P2-T23-R3A (2026-09-13)
...
R3A report: `codex-reports/P2_T23_R3A_BOUNDED_TRAJECTORY_TRANSPORT_IMPLEMENTATION.md`.
...
R2A reemplaza la decisión A0 de `CLIENT_INTERPOLATION_ONLY` para el próximo
ciclo de implementación, porque el producto exige conservar puntos GPS reales.
No se implementaron cambios funcionales. Reporte:
...
## P2-T23-A0 — trajectory batching + smooth playback design
...
La arquitectura futura mantiene backend current-point-only y deriva playback
acotado sólo entre puntos confirmados; no inicia T23, T24 ni T54. Reporte:
