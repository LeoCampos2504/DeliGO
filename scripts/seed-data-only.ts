// DeliGO - Fast Seed: Create 10 businesses in database (no image generation)
// Run with: bun run scripts/seed-data-only.ts

import { PrismaClient } from "@prisma/client"

const prisma = new PrismaClient()

// Use Cloudinary sample/placeholder URLs initially
const PLACEHOLDER_LOGO = "https://res.cloudinary.com/dztgrr6jn/image/upload/v1/placeholders/logo-placeholder"
const PLACEHOLDER_BANNER = "https://res.cloudinary.com/dztgrr6jn/image/upload/v1/placeholders/banner-placeholder"
const PLACEHOLDER_PRODUCT = "https://res.cloudinary.com/dztgrr6jn/image/upload/v1/placeholders/product-placeholder"
...
const businesses = [
  {
    ...
    ofreceDelivery: true, zonaDeliveryActiva: true, deliveryMode: "expert",
    precioDelivery: 500, precioDeliveryDefault: 500, tiempoEntrega: 45,
    lat: -26.1845, lng: -58.1732,
    horarioMode: "experto",
    horarios: JSON.stringify({ "1": { apertura: "11:00", cierre: "23:00" }, "2": { apertura: "11:00", cierre: "23:00" }, "3": { apertura: "11:00", cierre: "23:00" }, "4": { apertura: "11:00", cierre: "23:00" }, "5": { apertura: "11:00", cierre: "23:30" }, "6": { apertura: "11:00", cierre: "00:00" }, "7": { apertura: "11:00", cierre: "00:00" } }),
    ...
    whatsapp: "5493784551234", instagram: "@parrilladelcampo", aceptaTransferencia: true, aliasBancario: "parrilla.campo.mp",
    promocionado: true, ordenPromocion: 1,
    ...
    productos: [
      { nombre: "Asado para 2", precio: 8500, categoria: "Parrilla", descripcion: "Asado completo con vacío, entraña, chorizo y morcilla. Incluye chimichurri y salsas.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 15, imgPrompt: "Professional food photography of Argentine asado barbecue platter for two, assorted grilled meats with chimichurri sauce, rustic wooden board, warm lighting, appetizing" },
      ...
      { nombre: "Choripán Artesanal", precio: 2200, categoria: "Platos", descripcion: "Chorizo parrillero en pan casero con chimichurri y salsa criolla.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 20, imgPrompt: "Professional food photography of choripan artisanal chorizo sandwich in crusty bread with chimichurri, Argentine street food, warm lighting, appetizing" },
    ],
  },
  {
    slug: "sushi-zen",
    ...
    ofreceDelivery: true, zonaDeliveryActiva: true, deliveryMode: "expert",
    precioDelivery: 450, precioDeliveryDefault: 450, tiempoEntrega: 35,
    lat: -26.1820, lng: -58.1705,
    horarioMode: "experto",
    horarios: JSON.stringify({ "1": { apertura: "11:30", cierre: "22:30" }, "2": { apertura: "11:30", cierre: "22:30" }, "3": { apertura: "11:30", cierre: "22:30" }, "4": { apertura: "11:30", cierre: "22:30" }, "5": { apertura: "11:30", cierre: "23:00" }, "6": { apertura: "12:00", cierre: "23:30" }, "7": { apertura: "12:00", cierre: "22:30" } }),
    ...
    whatsapp: "5493784561234", instagram: "@sushizen.ok", aceptaTransferencia: true, aliasBancario: "sushi.zen.mp",
    promocionado: true, ordenPromocion: 2,
    ...
    productos: [
      { nombre: "Sushi Combinado 24 pcs", precio: 7800, categoria: "Sushi", descripcion: "Combinado de 24 piezas: 8 sashimi, 8 nigiri, 8 maki variados.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 10, imgPrompt: "Professional food photography of premium sushi combination platter 24 pieces, assorted nigiri sashimi and maki rolls on black slate, chopsticks, elegant presentation" },
  ...
  },
  {
    ...
    ofreceDelivery: true, zonaDeliveryActiva: true, deliveryMode: "expert",
    precioDelivery: 350, precioDeliveryDefault: 350, tiempoEntrega: 30,
    lat: -26.1865, lng: -58.1680,
    horarioMode: "experto",
    horarios: JSON.stringify({ "1": { apertura: "08:00", cierre: "21:00" }, "2": { apertura: "08:00", cierre: "21:00" }, "3": { apertura: "08:00", cierre: "21:00" }, "4": { apertura: "08:00", cierre: "21:00" }, "5": { apertura: "08:00", cierre: "21:00" }, "6": { apertura: "09:00", cierre: "22:00" }, "7": { apertura: "09:00", cierre: "15:00" } }),
    ...
    whatsapp: "5493784571234", instagram: "@laverdevida.ok", aceptaTransferencia: true, aliasBancario: "verde.vida.mp",
    ...
    productos: [
      ...
      { nombre: "Ensalada César Veggie", precio: 3500, categoria: "Ensaladas", descripcion: "Lechuga, croutons integrales, parmesano vegano, aderezo césar.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 15, imgPrompt: "Professional food photography of vegan Caesar salad with lettuce whole grain croutons and vegan parmesan, creamy dressing, fresh and green, appetizing" },
  ...
  },
  {
    ...
    ofreceDelivery: true, zonaDeliveryActiva: true, deliveryMode: "simple",
    precioDelivery: 400, precioDeliveryDefault: 400, tiempoEntrega: 25,
    lat: -26.1800, lng: -58.1750,
    horarioMode: "simple", horarios: "{}", abiertoManual: true,
    categorias: JSON.stringify(["Burgers", "Papas", "Combos", "Bebidas"]),
    zonasDelivery: JSON.stringify([]),
    whatsapp: "5493784581234", instagram: "@burgerlab.ok", aceptaTransferencia: true, aliasBancario: "burger.lab.mp",
    promocionado: true, ordenPromocion: 3,
    ...
    productos: [
      ...
      { nombre: "Doble Stack", precio: 5500, categoria: "Burgers", descripcion: "Doble medallón de 150g, doble cheddar, bacon y cebolla caramelizada.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 20, imgPrompt: "Professional food photography of double stack burger with two 150g patties double cheddar bacon and caramelized onions, tall burger, dramatic lighting" },
  ...
  },
  {
    ...
    ofreceDelivery: true, zonaDeliveryActiva: true, deliveryMode: "expert",
    precioDelivery: 400, precioDeliveryDefault: 400, tiempoEntrega: 40,
    lat: -26.1830, lng: -58.1710,
    horarioMode: "experto",
    horarios: JSON.stringify({ "1": { apertura: "18:00", cierre: "23:30" }, "2": { apertura: "18:00", cierre: "23:30" }, "3": { apertura: "18:00", cierre: "23:30" }, "4": { apertura: "18:00", cierre: "23:30" }, "5": { apertura: "18:00", cierre: "00:00" }, "6": { apertura: "18:00", cierre: "00:30" }, "7": { apertura: "19:00", cierre: "00:00" } }),
    ...
    whatsapp: "5493784591234", instagram: "@dolceforno.pizza", aceptaTransferencia: true, aliasBancario: "dolce.forno.mp",
    ...
    productos: [
      ...
      { nombre: "Pizza Fugazzeta", precio: 5200, categoria: "Pizzas", descripcion: "Pizza rellena de muzzarella y provolone con cebolla.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 10, imgPrompt: "Professional food photography of Argentine fugazzeta pizza stuffed with mozzarella and provolone cheese with onions, thick crust, cheese pull, appetizing" },
  ...
  },
  {
    ...
    ofreceDelivery: true, zonaDeliveryActiva: true, deliveryMode: "expert",
    precioDelivery: 400, precioDeliveryDefault: 400, tiempoEntrega: 30,
    lat: -26.1875, lng: -58.1690,
    horarioMode: "experto",
    horarios: JSON.stringify({ "1": { apertura: "11:00", cierre: "22:00" }, "2": { apertura: "11:00", cierre: "22:00" }, "3": { apertura: "11:00", cierre: "22:00" }, "4": { apertura: "11:00", cierre: "22:00" }, "5": { apertura: "11:00", cierre: "23:00" }, "6": { apertura: "11:00", cierre: "23:30" }, "7": { apertura: "12:00", cierre: "22:00" } }),
    categorias: JSON.stringify(["Tacos", "Burritos", "Entradas", "Bebidas"]),
    zonasDelivery: JSON.stringify([
      { nombre: "Centro", precio: 350, coords: [[-26.190, -58.180], [-26.190, -58.165], [-26.178, -58.165], [-26.178, -58.180]] },
    ]),
    whatsapp: "5493784601234", instagram: "@tacoloco.ok", aceptaTransferencia: true, aliasBancario: "taco.loco.mp",
    promocionado: true, ordenPromocion: 4,
    ...
    productos: [
      ...
      { nombre: "Burrito Supremo", precio: 4200, categoria: "Burritos", descripcion: "Burrito relleno de carne, arroz, frijoles, queso y guacamole.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 15, imgPrompt: "Professional food photography of supreme burrito stuffed with meat rice beans cheese and guacamole, large wrapped flour tortilla, appetizing" },
  ...
  },
  {
    ...
    ofreceDelivery: true, zonaDeliveryActiva: true, deliveryMode: "simple",
    precioDelivery: 300, precioDeliveryDefault: 300, tiempoEntrega: 20,
    lat: -26.1850, lng: -58.1720,
    horarioMode: "simple", horarios: "{}", abiertoManual: true,
    categorias: JSON.stringify(["Helados", "Milkshakes", "Postres Helados"]),
    zonasDelivery: JSON.stringify([]),
    whatsapp: "5493784611234", instagram: "@heladospatagonia", aceptaTransferencia: true, aliasBancario: "helados.patagonia.mp",
    ...
    productos: [
      ...
      { nombre: "Helado de Limón", precio: 1600, categoria: "Helados", descripcion: "2 bochas de limón al limone, refrescante y natural.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 10, imgPrompt: "Professional food photography of 2 scoops of fresh lemon ice cream in cup, bright yellow color, refreshing, mint garnish, appetizing" },
  ...
  },
  {
    ...
    ofreceDelivery: true, zonaDeliveryActiva: false, deliveryMode: "",
    precioDelivery: 0, precioDeliveryDefault: 0, tiempoEntrega: 20,
    lat: -26.1810, lng: -58.1765,
    horarioMode: "experto",
    horarios: JSON.stringify({ "1": { apertura: "07:00", cierre: "20:00" }, "2": { apertura: "07:00", cierre: "20:00" }, "3": { apertura: "07:00", cierre: "20:00" }, "4": { apertura: "07:00", cierre: "20:00" }, "5": { apertura: "07:00", cierre: "21:00" }, "6": { apertura: "08:00", cierre: "21:00" }, "7": { apertura: "08:00", cierre: "18:00" } }),
    categorias: JSON.stringify(["Café", "Panadería", "Desayunos", "Postres"]),
    zonasDelivery: JSON.stringify([]),
    whatsapp: "5493784621234", instagram: "@cafebuenavista", aceptaTransferencia: true, aliasBancario: "cafe.buenavista.mp",
    salonActivo: true, zonasSalon: JSON.stringify(["Interior", "Terraza"]),
    ...
    productos: [
      ...
      { nombre: "Tostadas con Palta", precio: 2800, categoria: "Desayunos", descripcion: "Tostadas artesanales con palta, huevo pochado y semillas.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 15, imgPrompt: "Professional food photography of artisan toast with avocado poached egg and seeds, healthy breakfast, bright natural lighting, appetizing" },
  ...
  },
  {
    ...
    ofreceDelivery: true, zonaDeliveryActiva: true, deliveryMode: "expert",
    precioDelivery: 450, precioDeliveryDefault: 450, tiempoEntrega: 35,
    lat: -26.1840, lng: -58.1740,
    horarioMode: "experto",
    horarios: JSON.stringify({ "1": { apertura: "11:00", cierre: "22:00" }, "2": { apertura: "11:00", cierre: "22:00" }, "3": { apertura: "11:00", cierre: "22:00" }, "4": { apertura: "11:00", cierre: "22:00" }, "5": { apertura: "11:00", cierre: "23:00" }, "6": { apertura: "12:00", cierre: "23:00" }, "7": { apertura: "12:00", cierre: "22:00" } }),
    ...
    whatsapp: "5493784631234", instagram: "@wokfusion.ok", aceptaTransferencia: true, aliasBancario: "wok.fusion.mp",
    ...
    productos: [
      ...
      { nombre: "Arroz Chino Especial", precio: 3800, categoria: "Arroces", descripcion: "Arroz frito con pollo, verduras y huevo. Estilo cantonés.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 10, imgPrompt: "Professional food photography of Cantonese special fried rice with chicken vegetables and egg, wok-charred, chopsticks, appetizing" },
  ...
  },
  {
    ...
    ofreceDelivery: true, zonaDeliveryActiva: true, deliveryMode: "simple",
    precioDelivery: 350, precioDeliveryDefault: 350, tiempoEntrega: 25,
    lat: -26.1860, lng: -58.1700,
    horarioMode: "experto",
    horarios: JSON.stringify({ "1": { apertura: "09:00", cierre: "21:00" }, "2": { apertura: "09:00", cierre: "21:00" }, "3": { apertura: "09:00", cierre: "21:00" }, "4": { apertura: "09:00", cierre: "21:00" }, "5": { apertura: "09:00", cierre: "22:00" }, "6": { apertura: "09:00", cierre: "22:00" }, "7": { apertura: "10:00", cierre: "20:00" } }),
    categorias: JSON.stringify(["Empanadas", "Combos", "Bebidas"]),
    zonasDelivery: JSON.stringify([]),
    whatsapp: "5493784641234", instagram: "@empanadasabuela", aceptaTransferencia: true, aliasBancario: "empanadas.abuela.mp",
    promocionado: true, ordenPromocion: 5,
    ...
    productos: [
      ...
      { nombre: "Empanada de Humita", precio: 800, categoria: "Empanadas", descripcion: "Empanada de choclo con queso y salsa blanca.", descuento: true, tipoDescuento: "porcentaje", valorDescuento: 20, imgPrompt: "Professional food photography of corn humita empanada, golden baked crust, cut open showing corn filling with cheese and white sauce, warm lighting, appetizing" },
...
async function seed() {
  console.log("🌱 DeliGO Fast Seed: Creating 10 businesses (no image generation)")
  console.log("")

  // Clean existing seed data by slug AND email
  console.log("🧹 Cleaning existing data...")
  const seedEmails = businesses.map(b => b.email)
  const seedSlugs = businesses.map(b => b.slug)

  // Find ALL negocios that match either slug or email
  ...
  for (let i = 0; i < businesses.length; i++) {
    ...
    console.log(`📋 [${i + 1}/${businesses.length}] ${biz.nombre}`)

    const negocio = await prisma.negocio.create({
      data: {
        slug: biz.slug, nombre: biz.nombre, usuario: biz.usuario, email: biz.email,
        password: biz.password, rubro: biz.rubro, aprobado: true, suspendido: false,
        emailVerified: new Date(), colorPrincipal: biz.colorPrincipal,
        mensajeBienvenida: biz.mensajeBienvenida || "",
        logoUrl: null, bannerUrl: null,
        ofreceDelivery: biz.ofreceDelivery, zonaDeliveryActiva: biz.zonaDeliveryActiva,
        deliveryMode: biz.deliveryMode || "", zonasDelivery: biz.zonasDelivery || "[]",
        precioDelivery: biz.precioDelivery, precioDeliveryDefault: biz.precioDeliveryDefault,
        tiempoEntrega: biz.tiempoEntrega, lat: biz.lat, lng: biz.lng,
        horarioMode: biz.horarioMode, horarios: biz.horarios || "{}",
        abiertoManual: (biz as any).abiertoManual ?? false,
        categorias: biz.categorias || "[]", agregadosCategorias: "[]",
        ingredientesCategorias: "[]", seccionesCatalogo: "[]",
        whatsapp: biz.whatsapp || "", instagram: biz.instagram || "", facebook: "",
        aceptaTransferencia: biz.aceptaTransferencia ?? false, aliasBancario: biz.aliasBancario || "",
        promocionado: biz.promocionado ?? false, ordenPromocion: biz.ordenPromocion ?? 0,
        salonActivo: (biz as any).salonActivo ?? false, zonasSalon: (biz as any).zonasSalon || "[]",
        empleadosActivos: false, mostrarVentas: true, planTipo: "prueba", deudaTarifa: 0, toleranciaCancelacion: 5,
      },
    })
    ...
    for (let ci = 0; ci < categorias.length; ci++) {
      await prisma.seccionCatalogo.create({ data: { nombre: categorias[ci], orientacion: "vertical", orden: ci, negocioId: negocio.id } })
    }

    // Create products
    for (let pi = 0; pi < biz.productos.length; pi++) {
      const prod = biz.productos[pi]
      const seccion = await prisma.seccionCatalogo.findFirst({ where: { negocioId: negocio.id, nombre: prod.categoria } })

      const producto = await prisma.producto.create({
        data: {
          nombre: prod.nombre, precio: prod.precio, categoria: prod.categoria,
          imagenUrl: null, descripcion: prod.descripcion || null, stock: true,
          descuentoActivo: prod.descuento ?? false, tipoDescuento: prod.tipoDescuento || "porcentaje",
          valorDescuento: prod.valorDescuento ?? 0, orden: pi, negocioId: negocio.id,
        },
      })

      if (seccion) {
        await prisma.seccionProducto.create({ data: { seccionId: seccion.id, productoId: producto.id, orden: pi } })
      }

      if (prod.descuento && prod.valorDescuento) {
        const precioPromo = prod.tipoDescuento === "porcentaje" ? prod.precio * (1 - prod.valorDescuento / 100) : prod.precio - prod.valorDescuento
        await prisma.promocion.create({
          data: { productoId: producto.id, negocioId: negocio.id, negocioSlug: biz.slug, negocioNombre: biz.nombre, precioOriginal: prod.precio, precioPromo, descuento: prod.tipoDescuento === "porcentaje" ? `${prod.valorDescuento}%` : `$${prod.valorDescuento}`, activa: true },
        })
      }
    ...
    if ((biz as any).salonActivo) {
      ...
      for (const mesa of mesas) {
        await prisma.mesa.create({ data: { ...mesa, activa: true, negocioId: negocio.id } })
      }
  ...
  if (existingConfig) {
    await prisma.configPlataforma.update({ where: { id: existingConfig.id }, data: { promocionadosActivos: true } })
  } else {
    await prisma.configPlataforma.create({ data: { promocionadosActivos: true } })
  }
  console.log("✅ Promocionados activados")

  console.log(`\n🎉 ${businesses.length} businesses with ${businesses.reduce((s, b) => s + b.productos.length, 0)} products created!`)
  console.log("⚠️ No images yet — run image generation script next.")
  await prisma.$disconnect()
}

seed().catch((e) => { console.error("❌ Seed error:", e); prisma.$disconnect(); process.exit(1) })
