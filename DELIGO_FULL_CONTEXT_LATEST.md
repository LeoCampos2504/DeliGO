...
## CURRENT AUTHORITATIVE STATE — P2-T24-R5.14 (2026-09-15)

Esta sección registra el probe físico corto terminado. El operador informó
saltos y un freeze recuperable mediante Recargar. La posible transición
WiFi→datos móviles queda sin probar: la ventana técnica posterior al baseline
89 no dejó witness observable del pedido, por lo que no se inventan métricas
ni se asigna una causa raíz.

```text
P2_T24_STATUS=IMPLEMENTED_PARTIALLY_TESTING_BLOCKED_NOT_RELEASE_ELIGIBLE
P2_T24_R5_STATUS=BLOCKED_TESTING_SHORT_PROBE_WITNESS_UNAVAILABLE
...
P2_T24_NEXT_ACTION=ROOT_CAUSE_FIX_DESIGN_REQUIRES_NEW_INSTRUMENTED_PROBE_OR_PERSISTED_WITNESS
```
