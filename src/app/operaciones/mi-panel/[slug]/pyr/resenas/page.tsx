...
// ============================================
// DeliGO Operaciones — Panel personal de PyR: reseñas (Operaciones-1N + UX-1)
// ============================================
...
//
// UX-1: esta pantalla vive en /pyr/resenas (antes era la raíz /pyr). La entrada principal
// de PyR ahora es /pyr/pedidos; /pyr redirige ahí. Se llega a esta pantalla desde la
// tarjeta "Ver reseñas" del listado de pedidos, o por URL directa.
    ...
    <Shell wide>
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <Button asChild variant="outline" size="icon" className="h-10 w-10 shrink-0 rounded-xl">
          <Link href={`/operaciones/mi-panel/${encodeURIComponent(slug)}/pyr/pedidos`} aria-label="Volver a pedidos activos">
            <ArrowLeft className="h-4 w-4" />
          </Link>
        </Button>
      </div>
