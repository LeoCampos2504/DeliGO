  ...
  try {
    ...
    const pedidosOut = pedidos.map((p) => ({
      ...
      items: p.items.map((item) => ({
        ...
        // P1-A.2A-ii: contrato plano estable — la Terminal Operativa de Salón
        // (src/app/operaciones/salon/page.tsx) ya normaliza con getIngredientesQuitadosNombres,
        // así que este endpoint entrega directamente ese mismo string[] normalizado,
        // nunca un objeto crudo.
