...
export function ProfileTab({ perfil, isLoading }: ProfileTabProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Google account info or Password change */}
      {perfil.googleId ? (
        <div className="rounded-2xl bg-card border border-border/50 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold">Cuenta de Google</p>
              <p className="text-xs text-muted-foreground">Ingresás con tu cuenta de Google</p>
            </div>
          </div>
        </div>
      ) : (
